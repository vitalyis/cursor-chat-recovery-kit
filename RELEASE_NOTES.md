...
Originally developed as internal tool to solve the "lost chat history after folder rename" problem. Tested and refined through real-world recovery scenarios.
